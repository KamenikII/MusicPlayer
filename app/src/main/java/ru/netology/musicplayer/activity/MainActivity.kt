package ru.netology.musicplayer.activity
...
import ru.netology.musicplayer.adapters.OnInteractionListener
import ru.netology.musicplayer.adapters.TrackAdapter
import ru.netology.musicplayer.dataclasses.Album
import ru.netology.musicplayer.dataclasses.Track
import ru.netology.musicplayer.viewmodel.SoundsViewModel
        ...
        lifecycleScope.launchWhenCreated {
            viewModel.isPlaying.collectLatest {
                if (mediaPlayer.isPlaying) {
                    findViewById<ImageButton>(R.id.play_album).setImageResource(R.drawable.ic_pause_circle)
                } else {
                    findViewById<ImageButton>(R.id.play_album).setImageResource(R.drawable.ic_play_circle)
                }
            }
        }
        lifecycleScope.launchWhenCreated {
